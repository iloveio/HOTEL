...
namespace HumanResourcesLib
{
    ...
    public interface IEmployeeFactory
    {
        ...
        Employee CreateEmployee(string name, string lastName, uint id, EmployeeStatus employeeStatus, float wage, List<Job> jobs,string login, string password, Postion position);
    }
}